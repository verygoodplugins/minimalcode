...
while ( have_posts() ) :
	...
	$author_avatar    = minimalcode_author_avatar_url( get_the_ID() );
	...
	<div class="single wrap">
		...
		<article id="post-<?php the_ID(); ?>" <?php post_class( 'single-post' ); ?>>
			...
			<div class="post-byline">
				<?php echo minimalcode_author_avatar( get_the_ID(), 28 ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped -- helper escapes internally. ?>
