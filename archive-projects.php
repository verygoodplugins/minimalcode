...
<div class="container">
	<div class="content-area">
		<header class="page-header projects-header">
			...
			<p class="archive-description"><?php esc_html_e( "Some of my open-source AI projects I've been playing with.", 'minimalcode' ); ?></p>
		</header>
		...
		<?php if ( have_posts() ) : ?>
			<div class="projects-grid">
				...
				while ( have_posts() ) :
					...
					// Get GitHub repo data for metadata.
					$repo_data = ! empty( $github_url ) ? minimalcode_get_github_repo_data( $github_url ) : false;
					?>
								...
								<div class="project-meta">
									<?php if ( ! empty( $repo_data['language'] ) ) : ?>
										<span class="project-language">
											<span class="language-dot" style="background-color: <?php echo esc_attr( minimalcode_get_language_color( $repo_data['language'] ) ); ?>"></span>
											<?php echo esc_html( $repo_data['language'] ); ?>
										</span>
									<?php endif; ?>

									<?php if ( $repo_data['stars'] > 0 ) : ?>
									...
									<?php if ( ! empty( $repo_data['updated_at'] ) ) : ?>
										<span class="project-updated">
											Updated <?php echo esc_html( minimalcode_time_ago( $repo_data['updated_at'] ) ); ?>
										</span>
									<?php endif; ?>
								</div>
							<?php endif; ?>
