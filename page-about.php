 ...
 * Description: About page with sidebar avatar and two-column layout
 *
 * @package MinimalCode
 */
			...
			<aside class="about-sidebar">
				<div class="about-avatar">
					<?php if ( has_post_thumbnail() ) : ?>
						<?php the_post_thumbnail( 'thumbnail', array( 'class' => 'avatar-image' ) ); ?>
					<?php else : ?>
				...
				<div class="about-social">
					...
					<?php if ( ! empty( $social_links['github'] ) ) : ?>
						<a href="<?php echo esc_url( $social_links['github'] ); ?>" target="_blank" rel="noopener noreferrer" aria-label="GitHub">
							<svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
